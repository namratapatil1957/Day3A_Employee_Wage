...
public class EmployeeWageforCompany {
	...
	EmployeeWageforCompany (String company_name, int wageperhrs, int workingdays, int workingmonthlyhrs) {
	...
	public static void main(String[] args) {
		...
		EmployeeWageforCompany amazon = new EmployeeWageforCompany("Amazon", 10, 20, 90);
		amazon.company();
		
		EmployeeWageforCompany flipkart = new EmployeeWageforCompany("Flipkart", 10, 20, 90);
		flipkart.company();
	}
